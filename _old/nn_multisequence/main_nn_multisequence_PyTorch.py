...
if __name__ == '__main__':
    ...
    par.load_dir = '/mnt/hpc/departmentN4/predictive_neuron_data/nn_multisequence_PyTorch_dataset/'+\
		'Dt_{}_nn_{}_N_{}_batch_{}_noise_{}_jitter_noise_{}_jitter_{}_freq_noise_{}_freq_{}/'.format(
                    par.Dt,par.nn,par.N,par.batch,par.noise,par.jitter_noise,par.jitter,
                    par.freq_noise,par.freq)
    ...
    if par.noise == 0:
        ...
        w,v,spk,loss = funs_train_inhibition.train_nn(par,network,timing=timing)

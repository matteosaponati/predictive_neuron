...
'initial conditions'
w_0_pre = np.array([.055,.08,])
w_0_post = np.array([.08,.055])
...
#%%
plt.plot(-delay[::-1],w_pre[::-1]/w_0_pre[0],linewidth=2)
plt.plot(delay,w_post/w_0_pre[0],linewidth=2)

...
if __name__ == '__main__':
    ...
    np.save(par.savedir+'w_nin_{}_nn_{}_delay_{}_Dt_{}_tau_{}_vth_{}_w0_{}'.format(
                            par.n_in,par.nn,par.delay,par.Dt,par.tau_m,par.v_th,par.w_0),w)
    np.save(par.savedir+'spk_nin_{}_nn_{}_delay_{}_Dt_{}_tau_{}_vth_{}_w0_{}'.format(
                            par.n_in,par.nn,par.delay,par.Dt,par.tau_m,par.v_th,par.w_0),spk)
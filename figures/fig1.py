...
plt.plot(vList[-1,0,0,:],color='navy',linewidth=2,label='epoch 0')
plt.plot(vList[-1,100,0,:],color='blue',linewidth=2,label='epoch 100')
fig.tight_layout(rect=[0, 0.01, 1, 0.97])
plt.legend()
plt.xlabel('time')
plt.ylabel('v')
#plt.savefig('fig1_b.png',format='png', dpi=300)
plt.savefig('plots/fig1_b.pdf',format='pdf', dpi=300)
plt.close('all')

...
plt.savefig('plots/fig3_c.pdf',format='pdf', dpi=300)
plt.close('all')
...
plt.xlabel('time [ms]')
plt.ylabel('neurons')
plt.savefig('plots/fig3_b_before.pdf',format='pdf', dpi=300)
plt.close('all') 
...
plt.xlabel('time [ms]')
plt.ylabel('neurons')
plt.savefig('plots/fig3_b_learning.pdf',format='pdf', dpi=300)
plt.close('all') 
...
plt.xlabel('time [ms]')
plt.ylabel('neurons')
plt.savefig('plots/fig3_b_after.pdf',format='pdf', dpi=300)
plt.close('all') 
...
plt.xlabel('time [ms]')
plt.ylabel('neurons')
plt.savefig('plots/fig3_b_spontaneous.pdf',format='pdf', dpi=300)
plt.close('all') 
...
'initial conditions'
w_0_pre = np.array([.005,.05])
w_0_post = np.array([.05,.005])
...
np.save(savedir+'w_pre_{}'.format(p_num['tau']),w_pre)
np.save(savedir+'w_post_{}'.format(p_num['tau']),w_post)

#%%
#import matplotlib.pyplot as plt
#
#plt.plot(-np.array(delay[::-1]),w_pre[::-1]/w_0_pre[0])
#
#plt.plot(delay,w_post/w_0_post[1])

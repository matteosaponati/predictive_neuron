...
performance = np.zeros((7,50))
timing = np.zeros((7,50))
...
plt.savefig('plots/figS8_timing.pdf',format='pdf',dpi=300)
plt.close()
...
plt.savefig('plots/figS8_performance.pdf',format='pdf',dpi=300)